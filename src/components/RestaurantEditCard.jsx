...
const RestaurantEditCard = ({ restaurant }) => {
  const [offersFood, setOffersFood] = useState('');
  const [cuisineVal, setCuisineVal] = useState('');
  const [typeOfPlace, setTypeOfPlace] = useState('');

  useEffect(() => {

    setOffersFood(restaurant?.offers_food);
    setCuisineVal(restaurant?.cuisine);
    setTypeOfPlace(restaurant?.type_of_place);
        ...
        <form
          ...
          <div className="col-span-full grid grid-rows-2 px-4">
            <select
              ...
              onChange={(e) => setCuisineVal(e.target.value)}
          ...
          <div className="col-span-full grid grid-rows-2 px-4">
            <select
              ...
              onChange={(e) => setOffersFood(e.target.value)}
              className="select select-bordered select-sm indent-1 font-normal bg-primary">
